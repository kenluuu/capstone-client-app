...
;function tc(a,b,c){var d=[],e=[];if(1==(ja(c)?2:1))return e=[b,a],C(d,function(a){e.push(a)}),uc(e.join(" "));
...
function cd(a,b,c){function d(a,b){if(D)return 0;hc.clearTimeout(y);N.push.apply(N,G);var d=((oc||{}).config||{}).update;d?d(f):f&&K(M,"cu",[]).push(f);if(b){Bc("me0",a,ta);try{$c(b,c,m)}finally{Bc("me1",a,ta)}}return 1}
a=nc(a)||[];var e=b.callback,f=b.config,g=b.timeout,h=b.ontimeout,k=b.onerror,m=void 0;"function"==typeof k&&(m=k);var y=null,D=!1;if(g&&!h||!g&&h)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var k=K(rc(c),"r",[]).sort(),N=K(rc(c),"L",[]).sort(),ta=[].concat(k);0<g&&(y=hc.setTimeout(function(){D=!0;h()},g));
...
function xd(a,b){if(ka(a))try{C(a,b,void 0)}catch(c){if(c!==ud)throw c;}else{a=wd(a);try{for(;;)b.call(void 0,a.next(),void 0,a)}catch(c){if(c!==ud)throw c;}}}
...
c.src=a}
;function mf(a,b,c,d,e){c={name:c||T("INNERTUBE_CONTEXT_CLIENT_NAME",1),version:d||T("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0)};e=window&&window.yterr||e||!1;if(a&&e&&!(5<=nf)){e=a.stacktrace;d=a.columnNumber;var f=t("window.location.href");if(q(a))a={message:a,name:"Unknown error",lineNumber:"Not available",fileName:f,stack:"Not available"};else{var g=!1;try{var h=a.lineNumber||a.line||"Not available"}catch(D){h="Not available",g=!0}try{var k=a.fileName||a.filename||a.sourceURL||n.$googDebugFname||
f}catch(D){k="Not available",g=!0}a=!g&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:k,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(d)||(h=h+":"+d);if(!(of[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){k=a.fileName;b={kb:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:h,level:b||"ERROR"},F:{url:T("PAGE_NAME",
...
function Df(a){a&&("string"==typeof a&&(a=[a]),C(a,function(a){if(a in Ga){var b=Ga[a],d=b[0],e=b[1],f=b[3],b=b[4];d.removeEventListener?d.removeEventListener(e,f,b):d.detachEvent&&d.detachEvent("on"+e,f);delete Ga[a]}}))}
...
ha(Fg);function Gg(a,b,c,d){b="string"==typeof b?b.split("."):[b,c,d];b[0]=parseInt(b[0],10)||0;b[1]=parseInt(b[1],10)||0;b[2]=parseInt(b[2],10)||0;return a.b>b[0]||a.b==b[0]&&a.f>b[1]||a.b==b[0]&&a.f==b[1]&&a.g>=b[2]}
;var Hg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Ig(a){a=a||"";if(window.spf){var b=a.match(Hg);spf.style.load(a,b?b[1]:"",void 0)}else Jg(a)}
function Jg(a){var b=Kg(a),c=document.getElementById(b),d=c&&te(c,"loaded");d||c&&!d||(c=Lg(a,b,function(){te(c,"loaded")||(ue(c),De(b),W(w(Ce,b),0))}))}
...
function Kg(a){var b=document.createElement("a");Lb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+va(a)}
;var X={},Mg=(X["api.invalidparam"]=2,X.auth=150,X["drm.auth"]=150,X["heartbeat.net"]=150,X["heartbeat.servererror"]=150,X["heartbeat.stop"]=150,X["html5.unsupportedads"]=5,X["fmt.noneavailable"]=5,X["fmt.decode"]=5,X["fmt.unplayable"]=5,X["html5.missingapi"]=5,X["html5.unsupportedlive"]=5,X["drm.unavailable"]=5,X);var Ng;var Og=F,Og=Og.toLowerCase();if(-1!=Og.indexOf("android")){var Pg=Og.match(/android\D*(\d\.\d)[^\;|\)]*[\;\)]/);if(Pg)Ng=Number(Pg[1]);else{var Qg={cupcake:1.5,donut:1.6,eclair:2,froyo:2.2,gingerbread:2.3,honeycomb:3,"ice cream sandwich":4,jellybean:4.1,kitkat:4.4,lollipop:5.1,marshmallow:6,nougat:7.1},Rg=[],Sg=0,Tg;for(Tg in Qg)Rg[Sg++]=Tg;var Ug=Og.match("("+Rg.join("|")+")");Ng=Ug?Qg[Ug[0]]:0}}else Ng=void 0;var Vg=['video/mp4; codecs="avc1.42001E, mp4a.40.2"','video/webm; codecs="vp8.0, vorbis"'],Wg=['audio/mp4; codecs="mp4a.40.2"'];function Xg(a){P.call(this);this.b=[];this.g=a||this}
z(Xg,P);function Yg(a,b,c,d){d=qe(v(d,a.g));d={target:b,name:c,sa:d};b.addEventListener(c,d.sa,void 0);a.b.push(d)}
function Zg(a){for(;a.b.length;){var b=a.b.pop();b.target.removeEventListener(b.name,b.sa)}}
Xg.prototype.o=function(){Zg(this);Xg.A.o.call(this)};var $g=t("ytLoggingLatencyUsageStats_")||{};r("ytLoggingLatencyUsageStats_",$g,void 0);var ah=0;function bh(a){$g[a]=$g[a]||{count:0};var b=$g[a];b.count++;b.time=me();ah||(ah=rf(ch,0));return 10<b.count?(11==b.count&&mf(Error("CSI data exceeded logging limit with key: "+a)),!0):!1}
...
;function Eh(a,b){P.call(this);this.B=this.l=a;this.U=b;this.D=!1;this.g={};this.aa=this.T=null;this.V=new R;rd(this,w(sd,this.V));this.j={};this.L=this.ba=this.i=this.ia=this.b=null;this.X=!1;this.M=this.C=this.w=this.R=null;this.ca={};this.Da=["onReady"];this.Y=new Xg(this);rd(this,w(sd,this.Y));this.ga=null;this.pa=NaN;this.Z={};Fh(this);this.G("onDetailedError",v(this.Ta,this));this.G("onTabOrderChange",v(this.Fa,this));this.G("onTabAnnounce",v(this.qa,this));this.G("WATCH_LATER_VIDEO_ADDED",v(this.Ua,
this));this.G("WATCH_LATER_VIDEO_REMOVED",v(this.Va,this));ub||(this.G("onMouseWheelCapture",v(this.Ra,this)),this.G("onMouseWheelRelease",v(this.Sa,this)));this.G("onAdAnnounce",v(this.qa,this));this.N=new Xg(this);rd(this,w(sd,this.N));this.ha=!1;this.fa=null}
...
function Lh(a){var b=a.b&&a.b.args&&a.b.args.fflags;if(b&&0<=b.indexOf("web_player_disable_flash=true"))return!1;if(!p(a.b.disable.flash)){var b=a.b.disable;var c=Gg(Fg.getInstance(),a.b.minVersion);b.flash=!c}return!a.b.disable.flash}
function Mh(a,b){var c;(c=!b)||(c=5!=(Mg[b.errorCode]||5)?!1:(c=a.b&&a.b.args&&a.b.args.fflags)&&0<=c.indexOf("web_player_disable_flash_fallback=true")?!1:-1!=Gh.indexOf(b.errorCode));if(c&&Lh(a)){(c=Nh(a))&&c.stopVideo&&c.stopVideo();var d=a.b;c&&c.getUpdatedConfigurationData&&(c=c.getUpdatedConfigurationData(),d=Dg(c));d.args.autoplay=1;d.args.html5_unavailable="1";Hh(a,d);Ih(a,"flash")}}
function Ih(a,b){if(!a.f){if(!b){var c;if(!(c=!a.b.html5&&Lh(a))){if(!p(a.b.disable.html5)){c=!0;void 0!=a.b.args.deviceHasDisplay&&(c=a.b.args.deviceHasDisplay);if(2.2==Ng)var d=!0;else{a:{var e=c;c=t("yt.player.utils.videoElement_");c||(c=document.createElement("VIDEO"),r("yt.player.utils.videoElement_",c,void 0));try{if(c.canPlayType)for(var e=e?Vg:Wg,f=0;f<e.length;f++)if(c.canPlayType(e[f])){d=null;break a}d="fmt.noneavailable"}catch(g){d="html5.missingapi"}}d=!d}d&&(d=Oh(a)||a.b.assets.js);
...
this.X=!0;a?this.R():(Ne(this.b.assets.js,this.R),Ig(this.b.assets.css),Rh(this)&&!b&&r("yt.player.Application.create",null,void 0))}}};
l.lb=function(){var a=Eg(this.b);if(!this.C){var b=Nh(this);b&&(this.C=document.createElement("SPAN"),this.C.tabIndex=0,Yg(this.Y,this.C,"focus",this.ua),this.M=document.createElement("SPAN"),this.M.tabIndex=0,Yg(this.Y,this.M,"focus",this.ua),b.parentNode&&b.parentNode.insertBefore(this.C,b),b.parentNode&&b.parentNode.insertBefore(this.M,b.nextSibling))}a.attrs.width=a.attrs.width||"100%";a.attrs.height=a.attrs.height||"100%";if("flash"==Ph(this))this.L="flash",this.D||this.P();else{Qh(this);this.L=
"flash";this.b.loaded=!0;var b=Fg.getInstance(),c=(-1<b.i.indexOf("Gnash")&&-1==b.i.indexOf("AVM2")||9==b.b&&1==b.f||9==b.b&&0==b.f&&1==b.g?0:9<=b.b)||-1<navigator.userAgent.indexOf("Sony/COM2")&&!Gg(b,9,1,58)?a.url:a.urlV9As2;window!=window.top&&document.referrer&&(a.args.framer=document.referrer.substring(0,128));b=this.l;if(c){var b=q(b)?Mb(b):b,d=Ja(a.attrs);d.tabindex=0;var e=Ja(a.params);e.flashvars=Wb(a.args);if(ne){d.classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000";e.movie=c;var a=document.createElement("object");
...
function Qh(a){rh("dcp");a.cancel();Fh(a);a.L=null;a.b&&(a.b.loaded=!1);var b=Nh(a);"html5"==Ph(a)?Oh(a)||!Rh(a)?a.w=b:(b&&b.destroy&&b.destroy(),a.w=null):b&&b.destroy&&b.destroy();for(var b=a.l,c;c=b.firstChild;)b.removeChild(c);Zg(a.Y);a.C=null;a.M=null}
